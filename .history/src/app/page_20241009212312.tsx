  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700">
      ...
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-teal-600 to-green-600 rounded-full blur-xl opacity-75 animate-pulse"></div>
        ...
        <Image
          ...
          className="relative rounded-full transform hover:scale-110 transition-transform duration-500 ease-out"
        />
      </div>
