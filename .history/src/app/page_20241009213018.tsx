...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700">
      ...
      <div className="relative w-full max-w-md"> {/* Reverted to original size with max-w-md */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-teal-600 to-green-600 rounded-lg blur-lg opacity-75 animate-pulse"></div> {/* Glow Effect */}
        
        <Image
          src="/IMG_2968.jpg" // Ensure this image is in the 'public' folder
          alt="Evan Wayne"
          width={300}  // Original width
          height={200} // Original height for a smaller rectangular shape
      ...
      <nav className="mt-8 flex space-x-4">
        ...
        <Link href="/resume">
          <button className="bg-teal-600 text-white text-xl​⬤