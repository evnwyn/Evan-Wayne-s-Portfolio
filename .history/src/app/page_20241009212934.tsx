...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700">
      ...
      <div className="relative w-full max-w-2xl"> {/* Adjusted max width */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-teal-600 to-green-600 rounded-lg blur-xl opacity-75 animate-pulse"></div> {/* Glow Effect */}
        
        <Image
          src="/IMG_2968.jpg" // Ensure this image is in the 'public' folder
          alt="Evan Wayne"
          width={700}  // Adjusted width
          height={400} // Adjusted height for a moderate rectangular shape
