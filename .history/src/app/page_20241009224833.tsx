...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 font-sans">
      
      {/* Glowing Image Container */}
      <div className="relative">
        <div className="absolute inset-0 w-[400px] h-[500px] bg-gradient-to-r from-blue-600 via-teal-600 to-green-600 rounded-lg blur-2xl opacity-50 animate-pulse"></div>
      ...
      <h1 className="text-7xl font-bold mt-8 text-center text-white transition-all duration-500 hover:text-gray-300">
      ...
      <nav className="mt-12 flex flex-wrap justify-center space-x-6">
        <Link href="/about">
