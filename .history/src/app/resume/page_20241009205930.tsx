...
export default function Resume() {
  return (
    <div className="flex flex-col items-center justify-center flex-grow w-full">
      ...
      <div className="mt-8">
        <Link href="/" passHref>
          <a className="bg-gray-600 text-white text-xl px-6 py-3 rounded-lg shadow-lg transform hover:bg-gray-700 hover:scale-110 transition-transform duration-500 ease-out">
            Go to Home Page
          </a>
        </Link>
      </div>
