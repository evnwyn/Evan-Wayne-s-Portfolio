...
export default function Resume() {
  return (
    <div className="flex flex-col items-center justify-center flex-grow w-full">
      ...
      {/* Stand-out Home button */}
      <div className="mt-8">
        <Link href="/" className="bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500 text-white text-xl px-8 py-4 rounded-full shadow-lg transform hover:scale-110 transition-transform duration-500 ease-out hover:shadow-2xl">
          Return to Home
        </Link>
      </div>
    </div>
