...
export default function Resume() {
  return (
    <div className="flex flex-col items-center justify-center flex-grow w-full font-sans"> {/* Apply the font to this specific page */}
      <div className="flex flex-col items-center pt-8 pb-4">
        <h1 className="text-6xl font-bold text-white transition-all duration-500 hover:text-gray-300">
          My Resume
        </h1>
        <a
          href="/Evan Wayne's Resume 09:10:2024.pdf"
          download
