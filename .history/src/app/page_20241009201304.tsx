...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-r from-blue-500 via-teal-500 to-green-500">
      <Image
      ...
      />
      <h1 className="text-6xl font-bold mt-8 text-center text-white whitespace-nowrap transition-all duration-500 hover:text-teal-200">
        Welcome to Evan Wayne's Portfolio
      </h1>
      <p className="mt-4 text-2xl text-center text-white max-w-2xl transition-all duration-500 hover:text-teal-300">
      ...
      <nav className="mt-8 flex space-x-4">
        ...
        <Link href="/resume">
          <button className="bg-teal-500 text-white text-xl px-6 py-3 rounded-lg shadow-lg transform hover:bg-teal-600 hover:scale-110 transition-transform duration-500 ease-out hover:shadow-xl">
            Resume
          </button>
        </Link>
        <Link href="/portfolio">
